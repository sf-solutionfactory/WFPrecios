...
{
    public partial class SolicitudPC : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (con.conectar())
                {
                    ...
                    if (Request.Form.AllKeys.Length > 0)
                    {
                        ...
                        IRfcTable a720 = con.consultaLPDetail("", "", spart, kunnr, "", "", "", "A720");
                        ...
                        tabla += "<tr><td class='tablahead'>Pedido del cliente</td><td class='tablahead'>Unidad</td>" +
                        ...
                        if (a720.Count > 0)
                        {
                            ...
                            for (int i = 0; i < ss.Count; i++)
                            {
                                ...
                                tabla += "' />";
                                tabla += "</td><td class='tablaCent'>";
                                tabla += "<select class='cell031' onchange='cambiaMone(this)' id='KONWA-" + pos + "'>";
