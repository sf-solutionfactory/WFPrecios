...
{
    public partial class tab4 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (con.conectar())
                {
                    ...
                    if (Request.Form.AllKeys.Length > 0)
                    {
                        ...
                        IRfcTable a720 = con.consultaLPDetail("", "", spart, "", matnr, "", pltyp, "A613");
                        ...
                        tabla += "<tr><td class='tablahead'>Material</td><td class='tablahead'>Denominación</td><td class='tablahead'>Unidad</td>" +
                        ...
                        else
                        {
                            if (!matnr.Trim().Equals(""))
                            {
                                ...
                                tabla += "<input type='hidden' id='MATNR-1' value='" + matnr + "' />";
                                tabla += matnr;
                                tabla += "</td>";
                                tabla += "<td>";
                                tabla += con.columnaMatnr(matnr, "MAKTG", "");
                                tabla += "</td>";
                                tabla += "<td>";
                                tabla += "<select  id='MEINS-1' class='cell031' style='width:40px;' onchange='cambiaMeins(this.id, this.value)' />";
                                tabla += formaMeins(con.columnaMatnr(matnr, "MEINS", ""), mei);
                                tabla += "</select>";
                                tabla += "</td>";
                                ...
                                if (con.columnaMatnr(matnr, "MEINS", "").Equals(""))
                                {
                                    txtMATNR.Value = "";
                                    tabla = "";
                                    txtPos.Value = "0";
                                ...
                                else
                                {
                                    btnAgregar.Disabled = true;
                                    btnSubmit.Disabled = false;
                                    valores += matnr + "|0.00||0.00|MXN||||X|" + con.columnaMatnr(matnr, "MEINS", "") + "| ";
                                    txtPos.Value = "0";
                                }
                            }
                            else
