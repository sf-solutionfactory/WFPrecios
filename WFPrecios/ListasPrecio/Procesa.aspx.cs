        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (oper != null)
                if (oper.Equals("N"))
                {
                    ...
                    links += "'>Rechazar</a>&nbsp;|&nbsp;<a href='Default.aspx'>Regresar</a>&nbsp;";
                    //links += "|&nbsp;<a href='https://www.terzaonline.com/nworkflow/login/'>Cerrar sesión</a>&nbsp;&nbsp;";
                    links += "&nbsp;";
                        ...
                        else if (tipoF.Equals("02"))
                        {
                            ...
                            if (header.Count > 0)
                            {
                                ...
                                for (int i = 0; i < detail.Count; i++)
                                {
                                    ...
                                    //s.desc2 = detail.GetString("SPART");
                                ...
                                foreach (SolicitudesL s in ss)
                                {
                                    ...
                                    if (tipo.Substring(1, 1).Equals("L"))
                                        tab += "<td class='cell18 " + style + "'>" + s.comentario + "</td>";
