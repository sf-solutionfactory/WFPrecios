<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab6.aspx.cs" Inherits="WFPrecios.Precios.tabs.tab6" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <input type="button" value="Cargar" class="btn right" runat="server" onclick="cargar()" id="btnCargar" />
                    <div class="right" style="width: 10px;">&nbsp;</div>
                    <input type="button" value="Agregar Nuevo" class="btn right" runat="server" onclick="add()" id="btnAgregar" />
            ...
            <script type="text/javascript">
                ...
                function cargar() {
                    ...
                    $('form').get(0).setAttribute('action', './tab6.aspx'); //this works
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <input type="hidden" runat="server" id="txtTipo" value="6" />
