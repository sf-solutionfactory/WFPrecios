<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitudPC.aspx.cs" Inherits="WFPrecios.Precios.SolicitudPC" %>
            ...
            <table id="Table1" style="border-width: 0px; border-style: None; width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td class="linksC">
                        ...
                        <a href="ExcelSP.aspx?Tipo=1">Carga Excel</a>&nbsp;|&nbsp;<a href="Default.aspx">Regresar</a>&nbsp;&nbsp;</td>
                </tr>
            </table>
        </div>
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <table style="position: relative; left: 50%; margin-left: -200px">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="cell05" type="text" id="txtNAME1" disabled="disabled" runat="server" />
                            </td>
                        </tr>
                         <tr>
            ...
            <script type="text/javascript">
                ...
                function cargar() {
                    ...
                    $('form').get(0).setAttribute('action', './SolicitudPC.aspx'); //this works
                ...
                function add() {
                    ...
                    if (posi == 1) {
                        ...
                        linea += "<tr><td class='tablahead'>Pedido del cliente</td><td class='tablahead'>Unidad</td>" +
                    ...
                    linea += "<tr id='tr-" + posi + "'>";
                     ...
                     linea += "<td class='tablaCent'><input class='cell031' type='text' id='MATNR-" + posi + "' onchange='cambiaPed(this)' ondblclick='escalas(this.id)' /></td>";
