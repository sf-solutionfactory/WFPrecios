<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab4.aspx.cs" Inherits="WFPrecios.Precios.tabs.tab4" %>
        ...
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <table style="position: relative; left: 50%; margin-left: -200px">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input class="cell07" type="text" id="txtMATNR" runat="server" />
            ...
            <script type="text/javascript">
                ...
                function cargar() {
                    ...
                    $('form').get(0).setAttribute('action', './tab4.aspx'); //this works
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <input type="hidden" runat="server" id="txtTipo" value="4" />
