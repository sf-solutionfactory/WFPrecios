<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab1.aspx.cs" Inherits="WFPrecios.Precios.tabs.tab1" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function llenar_material(id, value) {
            ...
            $.ajax({
                url: "../../catalogos.asmx/llena_matnr",
                data: JSON.stringify(param),
                dataType: "json",
                type: "POST",
                contentType: "application/json; charset=utf-8",
            ...
            $.ajax({
                ...
                dataFilter: function (data) { return data; },
                success: function (data) {
                    document.getElementById("MEINS-" + idd).value = data.d;
                    cambiaMeins("MEINS-" + idd, data.d);
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <table style="position: relative; left: 50%; margin-left: -200px">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input class="cell07" type="text" id="txtMATNR" runat="server" onchange="cambiaMatnr(this.value)" />
            ...
            <script type="text/javascript">
                ...
                function cargar() {
                    ...
                    $('form').get(0).setAttribute('action', './tab1.aspx'); //this works
                ...
                function cambiaPed2(id, valor) {
                    ...
                    for (var i = 0; i < tabla.length - 1; i += 10) {
                        ...
                        if (pos == id) {
                            ...
                            if (bban) {
                                nueva += "|";
                                document.getElementById("MATNR-" + id).value = "";
                            } else {
                                nueva += valor.split(' ')[0] + "|";
                            }
                        } else {
                ...
                function add() {
                    ...
                    if (posi == 1) {
                        ...
                        linea += "<tr><td class='tablahead'>Material</td><td class='tablahead'>Denominación</td><td class='tablahead'>Unidad</td>" +
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <input type="hidden" runat="server" id="txtTipo" value="1" />
