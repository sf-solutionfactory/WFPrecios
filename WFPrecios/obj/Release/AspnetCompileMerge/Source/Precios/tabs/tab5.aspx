<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tab5.aspx.cs" Inherits="WFPrecios.Precios.tabs.tab5" EnableEventValidation="true" %>
        ...
        function autocompleta_c(id) {
            $("#" + id).autocomplete({
                source: function (request, response) {
                    ...
                    var per = $('#hidNumEmp').val();
                    if (spa != null) {
                        var param = { pl: para.toUpperCase(), sp: spa, pr: per };
                        $.ajax({
                            url: "../../catalogos.asmx/auto_pltyp",
        ...
        <div class="container">
                ...
                <div class="col s12 m12 l12">
                    <table style="position: relative; left: 50%; margin-left: -200px">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <input class="cell07" type="text" name="txtPLTYP" id="txtPLTYP" runat="server" required="required" onchange="cambiaKunnr()" />
                                <script type="text/javascript">autocompleta_c("txtPLTYP");</script>
                            </td>
                        </tr>
                        <tr>
            ...
            <script type="text/javascript">
                ...
                function cambiaKunnr() {
                    //document.getElementById("txtPLTYP").value = document.getElementById("txtPLTYP").value.split(" -")[0];
                    if (ban)
                        ban = false;
                    else {
                        document.getElementById("btnCargar").disabled = true;
                ...
                function cargar() {
                    ...
                    $('form').get(0).setAttribute('action', './tab5.aspx'); //this works
            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    ...
                    <input type="hidden" runat="server" id="txtTipo" value="5" />
