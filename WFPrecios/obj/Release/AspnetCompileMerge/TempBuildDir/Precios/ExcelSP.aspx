<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcelSP.aspx.cs" Inherits="WFPrecios.Precios.tabs.ExcelSP" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function cargar() {
            ...
            $('form').get(0).setAttribute('action', './ExcelSP.aspx'); //this works
            document.forms["form1"].submit();
        }
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
                ...
                <div class="col s12 m12 l12 center">
                    <table style="position: relative; left: 50%; margin-left: -200px">
                        ...
                        <tr id="tr6" runat="server" visible="false">
                            ...
                            <td>
                                <input type="text" runat="server" id="txtMATNR1" class="cell05" disabled="disabled" /></td>
                        </tr>
            ...
            <div class="row">
                ...
                <input type="hidden" runat="server" id="txtMATNR" />
